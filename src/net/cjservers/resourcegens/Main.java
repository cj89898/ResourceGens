	...
	public void onEnable(){
		...
		if(Bukkit.getPluginManager().isPluginEnabled("Vault")){
			...
			if(!econ.setupEconomy()){
				getLogger().severe(String.format("Cannot hook into Vault Economy!"));
				getLogger().severe(String.format("Make sure to have a Vault compatible economy plugin installed!"));
			}else{
				econ.setupEconomy();
				econEnabled = true;
			}
